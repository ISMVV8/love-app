...
function MatchesSkeleton() {
  return (
    <div className="pt-4">
      <Skeleton className="h-4 w-32 rounded-lg mb-4 mx-4" />
      ...
      <Skeleton className="h-4 w-24 rounded-lg mb-3 mx-4" />
...
function LikesSkeleton() {
  return (
    <div className="px-4 pt-4">
      <Skeleton className="h-8 w-24 rounded-lg mb-5" />
...
function ProfileSkeleton() {
  return (
    <div>
      <Skeleton className="w-full aspect-[3/4] max-h-[55dvh] !rounded-none" />
  ...
  return (
    <div className="flex flex-col h-dvh bg-[#0C0C0E]">
      ...
      <div className="flex-1 px-3 py-3 flex flex-col justify-end gap-2">
        ...
        <div className="flex justify-start"><Skeleton className="h-10 w-36 !rounded-2xl" /></div>
